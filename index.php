                        ...
                        <div class="bl_about">
                            <div class="bl_about_inner">
                                ...
                                <div class="bl_aboutIntroduction">
                                    <div class="bl_aboutImg" style="background: url(<?php echo get_template_directory_uri(); ?>/image/top/yama.jpg) center center /cover;">
                                    </div>
                                ...
                                <div class="bl_workSlick js-slick">
                                    <div class="bl_workCarousel_wrap">
                                        <ul id="carousel" class="bl_workCarousel_list">
                                            <li>
                                                <article class="bl_workCarousel_item">
                                                    <a href="<?php echo home_url(); ?>" class="bl_worklink">
                                                        <div class="bl_workImg" style="background: url(<?php echo get_template_directory_uri(); ?>/image/top/portfolio-site.jpg) center center/cover;">
                                                        </div>
                                            ...
                                            <li>
                                                <article class="bl_workCarousel_item">
                                                    <div class="bl_workImg" style="background: url(<?php echo get_template_directory_uri(); ?>/image/top/work.jpg) center center/cover;">
                                                    </div>
